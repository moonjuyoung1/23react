            ...
            <aside>
              ...
              <div className="side">
                ...
                <div className="bottom">
                    <img src="/images/wecode.jpg" alt="wecodelog" className="circle"/>
                    <div className="idWrap"><span className="commentId">eun_hinn</span><span className="commentContent">mj_thewildboar님 외 1명이 팔로우</span></div>
                    <span className="follow">팔로우</span>
                </div>
        
                <div className="bottom">
                    <img src="/images/wecode.jpg" alt="wecodelog" className="circle"/>
                    <div className="idWrap"><span className="commentId">khjo_91</span><span className="commentContent">brent_Kim_님이 팔로우합니다</span></div>
                    <span className="follow">팔로우</span>
                </div>
        
                <div className="bottom">
                    <img src="/images/wecode.jpg" alt="wecodelog" className="circle"/>
                    <div className="idWrap"><span className="commentId">elephant5288</span><span className="commentContent">no_ans_cs님이 팔로우 합니다.</span></div>
                    <span className="follow">팔로우</span>
                </div>
        
                <div className="bottom">
                    <img src="/images/wecode.jpg" alt="wecodelog" className="circle"/>
                    <div className="idWrap"><span className="commentId">attyhelory</span><span className="commentContent">giv_meee님 외 1명이 팔로우 합니다.</span></div>
                    <span className="follow">팔로우</span>
                </div>
                
                <div className="authorization"><p>instagram 정보·지원·홍보 센터·API·<br/>채용정보·개인정보처리방침·약관·<br/>디렉터리·프로필·해시태크·언어
                        <br/><br/>2019 INSTAGRAM</p>
                </div>
